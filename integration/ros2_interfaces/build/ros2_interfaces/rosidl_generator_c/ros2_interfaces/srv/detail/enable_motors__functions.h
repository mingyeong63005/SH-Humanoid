...
#ifndef ROS2_INTERFACES__SRV__DETAIL__ENABLE_MOTORS__FUNCTIONS_H_
#define ROS2_INTERFACES__SRV__DETAIL__ENABLE_MOTORS__FUNCTIONS_H_
...
/// Initialize srv/EnableMotors message.
/**
...
/// Finalize srv/EnableMotors message.
/**
...
/// Create srv/EnableMotors message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_interfaces__srv__EnableMotors_Request__init().
...
/// Destroy srv/EnableMotors message.
/**
 * It calls
 * ros2_interfaces__srv__EnableMotors_Request__fini()
...
/// Check for srv/EnableMotors message equality.
/**
...
/// Copy a srv/EnableMotors message.
/**
...
/// Initialize array of srv/EnableMotors messages.
/**
...
/// Finalize array of srv/EnableMotors messages.
/**
 * It calls
 * ros2_interfaces__srv__EnableMotors_Request__fini()
...
/// Create array of srv/EnableMotors messages.
/**
 * It allocates the memory for the array and calls
 * ros2_interfaces__srv__EnableMotors_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/EnableMotors messages.
/**
 * It calls
 * ros2_interfaces__srv__EnableMotors_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EnableMotors message array equality.
/**
...
/// Copy an array of srv/EnableMotors messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_interfaces__srv__EnableMotors_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces
...
/**
 * It calls
 * ros2_interfaces__srv__EnableMotors_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros2_interfaces__srv__EnableMotors_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces
...
/**
 * It calls
 * ros2_interfaces__srv__EnableMotors_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_INTERFACES__SRV__DETAIL__ENABLE_MOTORS__FUNCTIONS_H_
