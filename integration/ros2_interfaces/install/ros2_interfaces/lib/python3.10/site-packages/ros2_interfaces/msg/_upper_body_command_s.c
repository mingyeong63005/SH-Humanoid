...
bool ros2_interfaces__msg__upper_body_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces.msg._upper_body_command.UpperBodyCommand", full_classname_dest, 56) == 0);
  }
  ros2_interfaces__msg__UpperBodyCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // motor_id
    ...
    }
    {
      ...
      Py_ssize_t size = 15;
      uint8_t * dest = ros_message->motor_id;
...
{
  /* NOTE(esteve): Call constructor of UpperBodyCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces.msg._upper_body_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UpperBodyCommand");
  ...
  {  // motor_id
    ...
    uint8_t * src = &(ros_message->motor_id[0]);
    memcpy(dst, src, 15 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // position
    PyObject * field = NULL;
