...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/Volumes/Data/SamHyun/HRController/ros2_interfaces/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/opt/homebrew/Caskroom/miniforge/base/envs/ros2_humble/bin/python3.10"
